local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/DwngKhoi/KhoiScript/main/source.lua')))()
...
local MainFarm = Window:MakeTab({Name = "Main Farm",PremiumOnly = false})
local FruitTab = Window:MakeTab({Name = "Fruit",PremiumOnly = false})
local LocalPTab = Window:MakeTab({Name = "Local Player",PremiumOnly = false})
local TravelTab = Window:MakeTab({Name = "Travel",PremiumOnly = false})
local PvpTab = Window:MakeTab({Name = "Pvp-Visual",PremiumOnly = false})
local RaidTab = Window:MakeTab({Name = "Raid-Material",PremiumOnly = false})
local RaceV4Tab = Window:MakeTab({Name = "RaceV4-Mirage",PremiumOnly = false})
local SeaTab = Window:MakeTab({Name = "Sea Events",PremiumOnly = false})
local ShopTab = Window:MakeTab({Name = "Shop",PremiumOnly = false})
local SettingTab = Window:MakeTab({Name = "Setting",PremiumOnly = false})
local MiscTab = Window:MakeTab({Name = "Game-Server",PremiumOnly = false})


MainFarm:AddLabel("Only Turn On 1 Farm At The Same Time")
local WeaponList = {"Melee","Sword","Fruit","Gun"}
_G.SelectWeapon = "Melee"
MainFarm:AddDropdown({Name = "Select Weapon",Default = "Melee",Options = WeaponList,
Callback = function(value)
	...
	while wait(.1) do
		if _G.FastAttack then
		   ...
		   LocalPTab:AddToggle({Name = "Turn On V4 Race",Default = false,function(value)
	...
	SettingTab:AddToggle({Name = "Fast Attack ",Default = true,function(value)
			_G.FastAttack = value
		end})      
	   
	MainFarm:AddToggle({Name = "Auto Level",Default = _G.AutoFarm,function(value)
			_G.AutoFarm = value
	   ...
	   MainFarm:AddToggle({Name = "Kill Aura | Nearest",Default = _G.AutoFarmNearest,function(value)
...
MainFarm:AddButton({
	...
	Callback = function()
		setfpscap(9999999)
		loadstring(game:HttpGet("https://raw.githubusercontent.com/DwngKhoi/KhoiScript/main/fpsbut.lua"))()
  	end    
})
