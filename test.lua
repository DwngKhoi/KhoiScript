local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/DwngKhoi/MrKhoiUI/master/MainUI.lua"))()
...
ImageButton.Image = "rbxassetid://16108795672"
...
do
    ...
    local SWeapon = Tabs.Main:AddDropdown("Dropdown", {
        Title = "Select Weapon",
        Values = WeaponList,
        Multi = false,
        Default = 1,
    })
    SWeapon:OnChanged(function(value)
            ...
            if _G.AutoBone then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        if BypassTP then
                            wait()
                           if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - ThuyTienCuti.Position).Magnitude > 2500 then
                           BTP(ThuyTienCuti)
                  
                           elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - ThuyTienCuti.Position).Magnitude < 2500 then
                    ...
                    if (ThuyTienCuti.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then    
    ...
    local RFruit = Tabs.Shop:AddToggle("MyToggle", {Title = "Auto Random Fruit", Default = false })
    RFruit:OnChanged(function(value)
    ...
    local RBone = Tabs.Shop:AddToggle("MyToggle", {Title = "Auto Random Bone", Default = false })
    RBone:OnChanged(function(value)
    ...
    local AutoRJoin = Tabs.GameSV:AddToggle("MyToggle", {Title = "Auto Rejoin", Default = true })
    AutoRJoin:OnChanged(function(value)
        _G.AutoRejoin = value
    end)
